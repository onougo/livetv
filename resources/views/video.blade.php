	        ...
	        slidesToShow: 2
                        ...
                        <div class="col-2" data-id="92570808" data-category="Pop" data-tag="Canada"
                            ...
                            <div class="list-item slick-item r mb-3">
                                <div class="media"><a href="{{ route('video_detail') }}" class="ajax media-content"
                                ...
                                <div class="list-content text-center">
                                    <div class="list-body"><a href="{{ route('video_detail') }}"
                        ...
                        <div class="col-2" data-id="119205187" data-category="all" data-tag="all"
                            ...
                            <div class="list-item slick-item r mb-3">
                                ...
                                <div class="list-content text-center">
                                    <div class="list-body"><a href="{{ route('video_detail') }}"
                                                              class="list-title title ajax h-1x">God Over Everything</a>
                                        <a href="#"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row row-sm">
                                <div class="col-6">
                                    <div class="list-item list-overlay r mb-3 gd-primary">
                                        <div class="media media-4x3"><a href="{{ route('video_detail') }}" class="ajax media-content"
                            ...
                            <div class="row row-sm">
                                <div class="col-4">
                                    <div class="list-item r">
                                        <div class="media media-16x9"><a href="#"
